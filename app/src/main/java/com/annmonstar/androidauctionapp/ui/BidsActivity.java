...
import com.annmonstar.androidauctionapp.Adapter.BidsAdapter;
...
public class BidsActivity extends AppCompatActivity {
    ...
    BidsAdapter mAdapter;
    List<BiddingModal> mBids = new ArrayList<BiddingModal>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BidsAdapter(this, mBids);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    reference.child(Objects.requireNonNull(dataSnapshot.getKey())).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            BiddingModal biddingModel = snapshot.getValue(BiddingModal.class);
    ...
    private void generatePDF() {
        ...
        File outputFile = new File(Environment.getExternalStorageDirectory().getPath(), "Bids.pdf");
